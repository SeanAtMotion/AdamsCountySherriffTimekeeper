        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BadgeNumber = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakStartUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BreakEndUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    TimeEntryId = table.Column<int>(type: "int", nullable: false),
                    RequestedClockInUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RequestedClockOutUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RequestedBreakStartUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RequestedBreakEndUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CorrectionRequests", x => x.CorrectionRequestId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CorrectionRequests_Employees_ReviewedByEmployeeId",
                        column: x => x.ReviewedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CorrectionRequests_TimeEntries_TimeEntryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CorrectionRequests_ReviewedByEmployeeId",
                table: "CorrectionRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CorrectionRequests_TimeEntryId",
                table: "CorrectionRequests",
                column: "TimeEntryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_ClockInUtc",
                table: "TimeEntries",
                column: "ClockInUtc");

            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_ClockOutUtc",
                table: "TimeEntries",
                column: "ClockOutUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_EntryStatus",
                table: "TimeEntries",
                column: "EntryStatus");
        }
